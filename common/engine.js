			...
			for(j = i + 1; j < entityCount; j++) {
				...
				if(entity.owner !== entity2.id && entity2.owner !== entity.id &&
					...
					switch(entity.type+entity2.type) {
						...
						// Player collides with an object
						case 'playerobject': entity2.handleCollision(entity); break;
						case 'objectplayer': entity.handleCollision(entity2); break;
						case 'objectobject': entity.handleCollision(entity2); break;
